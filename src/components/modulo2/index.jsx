    ...
    <section className="consejos" id="maquillaje">
      <div className="container">
        ...
        <div className="row flex-row flex-wrap text-center">
          ...
          >
           <iframe width="560" height="315" src="https://www.youtube.com/embed/QqoyTi9wjVU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          ...
          <div
            className="col-md-6 col-sm-12 flex-wrap"
          >
           <iframe width="560" height="315" src="https://www.youtube.com/embed/h4me536seuE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
